...
bool isPrintableKey(int colIndex, int rowIndex) {
  return keyboard_symbol[colIndex][rowIndex] != NULL || keyboard[colIndex][rowIndex] != NULL || keyboard_alt[colIndex][rowIndex] != NULL;
}
        ...
        for (int colIndex=0; colIndex < colCount; colIndex++) {
          ...
          if (keyPressed(colIndex, rowIndex) && isPrintableKey(colIndex, rowIndex)) {
            ...
            if(input <= 255) {
              ...
              Keyboard.releaseAll();
            } else if(input >= MOD_LEFT_CTRL && input < MOD_LEFT_SHIFT) {
              Serial.println("CTRL_L");
              Keyboard.press(KeyboardKeycode(KEY_LEFT_CTRL));
              Keyboard.press(KeyboardKeycode(input - MOD_LEFT_CTRL));
              delay(10);
              Keyboard.releaseAll();
            } else if(input >= MOD_LEFT_SHIFT && input < MOD_LEFT_ALT) {
              Serial.println("SHIFT_L");
              Keyboard.press(KeyboardKeycode(KEY_LEFT_SHIFT));
              Keyboard.press(KeyboardKeycode(input - MOD_LEFT_SHIFT));
              delay(10);
              Keyboard.releaseAll();
            } else if(input >= MOD_LEFT_ALT && input < MOD_LEFT_GUI) {
              Serial.println("ALT_L");
              Keyboard.press(KeyboardKeycode(KEY_LEFT_ALT));
              Keyboard.press(KeyboardKeycode(input - MOD_LEFT_ALT));
              delay(10);
              Keyboard.releaseAll();
            } else if(input >= MOD_RIGHT_ALT && input < MOD_RIGHT_GUI) {
              Serial.println("ALT_R");
              Keyboard.press(KeyboardKeycode(KEY_RIGHT_ALT));
              Keyboard.press(KeyboardKeycode(input - MOD_RIGHT_ALT));
              delay(10);
              Keyboard.releaseAll();
            }
          }
